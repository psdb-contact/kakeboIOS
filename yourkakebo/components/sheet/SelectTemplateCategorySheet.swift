...
struct SelectTemplateCategorySheet: View {
    ...
    var body: some View {
        SelectTemplateCategoryContentSheet(
...
private struct SelectTemplateCategoryContentSheet: View {
    ...
    private func save(category: CategoryModel) {
        do {
            try viewModel.save(
                template: TemplateModel(category: category)
            )
        } catch {}
    }
}

struct SelectTemplateCategoryForm : View {
